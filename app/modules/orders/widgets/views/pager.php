...
<div class="col-sm-8">
    <nav>
        <ul class="pagination">
            <?php
            $pager = '<li class="disabled"><a href="/orders?page='
            ...
            while ($page < ($curr_page + 10)) {
                if (($page + 1) <= $pages) {
                    $pager .= '<li><a href="/orders?page=' . ($page + 1) . ((int)$params['service'] !== null ? '&service=' . $params['service'] : '') .
            ...
            $pager .= '<li class="disabled"><a href="/orders?page=' . ($curr_page == $pages ? $curr_page . '#' : ($curr_page + 1))
